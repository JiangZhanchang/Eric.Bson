...
namespace Metsys.Bson
{
    public class Deserializer
    {
        ...
        private static bool _guidIsLittleEndian = true;
        ...
        public static T Deserialize<T>(byte[] objectData, bool guidIsLittleEndian = true) where T : class
        {
            _guidIsLittleEndian = guidIsLittleEndian;
        ...
        public static object Deserialize(MemoryStream ms, Type type, bool guidIsLittleEndian = true)
        {
            _guidIsLittleEndian = guidIsLittleEndian;
            ms.Position = 0;
        ...
        private object ReadBinary()
        {
            ...
            {
                var guidNormal = new Guid(_reader.ReadBytes(length));
                return _guidIsLittleEndian ? guidNormal : guidNormal.ReveseSequence();
            }
