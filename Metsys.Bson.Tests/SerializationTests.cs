...
namespace Metsys.Bson.Tests
{
    public class SerializationTests
    {
        ...
        public static void Main()
        {
            ...
            BsonConfiguration.ForType(configuration => configuration.Ignore(typeof(TestClass),"Name"));
            var result = Serializer.Serialize(new TestClass() { Id = guid, Name = "TestName" });

            var converted = Deserializer.Deserialize<TestClass>(result);
        }
